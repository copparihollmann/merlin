...
module {
  util.func public @main_graph$async(%a_arg0: !hal.buffer_view, %a_arg1: !hal.fence, %a_arg2: !hal.fence) -> !hal.buffer_view attributes {inlining_policy = #util.inline.never, iree.abi.model = "coarse-fences", iree.abi.stub} {
    ...
    %a_0 = hal.tensor.import wait(%a_arg1) => %a_arg0 : !hal.buffer_view -> tensor<1x3x64x64xf32>
    %a_padded = tensor.pad %a_0 low[0, 0, 1, 1] high[0, 0, 1, 1] {
    ^bb0(%a_arg3: index, %a_arg4: index, %a_arg5: index, %a_arg6: index):
      tensor.yield %a_cst_3 : f32
    ...
    %a_13 = hal.tensor.barrier join(%a_collapsed_5 : tensor<2xf32>) => %a_arg2 : !hal.fence
    %a_14 = hal.tensor.export %a_13 : tensor<2xf32> -> !hal.buffer_view
    util.return %a_14 : !hal.buffer_view
  }
  util.func public @main_graph(%a_arg0: !hal.buffer_view) -> !hal.buffer_view attributes {iree.abi.stub} {
    %a_0 = util.null : !hal.fence
    %a_c-1_i32 = arith.constant -1 : i32
    %a_c0 = arith.constant 0 : index
    %a_device_0 = hal.devices.get %a_c0 : !hal.device
    %a_fence = hal.fence.create device(%a_device_0 : !hal.device) flags("None") : !hal.fence
    %a_1 = util.call @main_graph$async(%a_arg0, %a_0, %a_fence) : (!hal.buffer_view, !hal.fence, !hal.fence) -> !hal.buffer_view
    %a_status = hal.fence.await until([%a_fence]) timeout_millis(%a_c-1_i32) flags("None") : i32
    util.return %a_1 : !hal.buffer_view
  }
}
