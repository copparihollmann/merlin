module {
  func.func @main_graph(%arg0: !torch.vtensor<[2],f32>, %arg1: !torch.vtensor<[2],f32>) -> !torch.vtensor<[2],f32> attributes {torch.onnx_meta.ir_version = 8 : si64, torch.onnx_meta.opset_version = 18 : si64, torch.onnx_meta.producer_name = "pytorch", torch.onnx_meta.producer_version = "2.8.0"} {
    ...
    %78 = torch.operator "onnx.Constant"() {torch.onnx.value = dense_resource<__24> : tensor<f32>} : () -> !torch.vtensor<[],f32> 
    %79 = torch.operator "onnx.Mul"(%77, %78) : (!torch.vtensor<[2],f32>, !torch.vtensor<[],f32>) -> !torch.vtensor<[2],f32> 
    %80 = torch.operator "onnx.Add"(%arg0, %79) : (!torch.vtensor<[2],f32>, !torch.vtensor<[2],f32>) -> !torch.vtensor<[2],f32> 
    return %80 : !torch.vtensor<[2],f32>
  }
}
