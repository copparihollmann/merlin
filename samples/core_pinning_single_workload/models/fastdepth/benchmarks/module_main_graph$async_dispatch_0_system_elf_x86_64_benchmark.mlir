module {
  ...
  util.initializer {
    ...
    %c11140352 = arith.constant 11140352 : index
    %buffer = hal.allocator.allocate<%allocator : !hal.allocator> affinity(%queue_affinity) type(%memory_type) usage(%buffer_usage) : !hal.buffer{%c11140352}
  ...
  util.func public @main_graph$async_dispatch_0_system_elf_x86_64_main_graph$async_dispatch_0_slow_memcpy(%arg0: i32) attributes {iree.abi.stub, iree.reflection = {iree.benchmark = "dispatch"}} {
    ...
    scf.for %arg1 = %c0 to %0 step %c1 {
      hal.command_buffer.dispatch<%cmd : !hal.command_buffer> target(%exe : !hal.executable)[%ordinal] workgroups([%workgroup_x, %workgroup_y, %workgroup_z]) bindings([
        (%main_graph$async_dispatch_0_system_elf_x86_64_main_graph$async_dispatch_0_slow_memcpy_buffer : !hal.buffer)[%c0, %c602112], 
        (%main_graph$async_dispatch_0_system_elf_x86_64_main_graph$async_dispatch_0_slow_memcpy_buffer : !hal.buffer)[%c602112, %c10538048]
      ]) flags("None")
