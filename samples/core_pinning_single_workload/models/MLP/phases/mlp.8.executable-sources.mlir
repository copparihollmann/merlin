...
module attributes {stream.affinity.default = #hal.device.affinity<@__device_0>} {
  ...
  hal.executable private @main_graph$async_dispatch_0 {
    hal.executable.variant public @system_elf_x86_64 target(#executable_target_system_elf_x86_64) {
      ...
      builtin.module {
        func.func @main_graph$async_dispatch_0_matmul_like_Dx32x10_f32() {
          ...
          %15 = linalg.fill ins(%cst : f32) outs(%14 : tensor<?x32xf32>) -> tensor<?x32xf32>
          %16 = linalg.generic {indexing_maps = [#map, #map1, #map2], iterator_types = ["parallel", "parallel", "reduction"]} ins(%12, %13 : tensor<?x10xf32>, tensor<32x10xf32>) outs(%15 : tensor<?x32xf32>) {
          ^bb0(%in: f32, %in_1: f32, %out: f32):
            %18 = arith.mulf %in, %in_1 : f32
            %19 = arith.addf %out, %18 : f32
            linalg.yield %19 : f32
          } -> tensor<?x32xf32>
          %17 = linalg.generic {indexing_maps = [#map3, #map4, #map3], iterator_types = ["parallel", "parallel"]} ins(%16, %cst_0 : tensor<?x32xf32>, tensor<32xf32>) outs(%14 : tensor<?x32xf32>) {
          ^bb0(%in: f32, %in_1: f32, %out: f32):
  ...
  hal.executable private @main_graph$async_dispatch_1 {
    hal.executable.variant public @system_elf_x86_64 target(#executable_target_system_elf_x86_64) {
      ...
      builtin.module {
        func.func @main_graph$async_dispatch_1_matmul_like_Dx32x32_f32() {
          %c32_i64 = arith.constant 32 : i64
          %cst = arith.constant 0.000000e+00 : f32
          ...
          %22 = linalg.fill ins(%cst : f32) outs(%21 : tensor<?x32xf32>) -> tensor<?x32xf32>
          %23 = linalg.generic {indexing_maps = [#map, #map1, #map2], iterator_types = ["parallel", "parallel", "reduction"]} ins(%19, %20 : tensor<?x32xf32>, tensor<32x32xf32>) outs(%22 : tensor<?x32xf32>) {
          ^bb0(%in: f32, %in_1: f32, %out: f32):
            %25 = arith.mulf %in, %in_1 : f32
            %26 = arith.addf %out, %25 : f32
            linalg.yield %26 : f32
          } -> tensor<?x32xf32>
          %24 = linalg.generic {indexing_maps = [#map3, #map4, #map3], iterator_types = ["parallel", "parallel"]} ins(%23, %cst_0 : tensor<?x32xf32>, tensor<32xf32>) outs(%21 : tensor<?x32xf32>) {
          ^bb0(%in: f32, %in_1: f32, %out: f32):
    ...
    hal.executable.variant public @system_elf_x86_64 target(#executable_target_system_elf_x86_64) {
      ...
      builtin.module {
        func.func @main_graph$async_dispatch_2_matmul_like_Dx2x32_f32() {
          ...
          %21 = linalg.generic {indexing_maps = [#map, #map1, #map2], iterator_types = ["parallel", "parallel", "reduction"]} ins(%18, %cst_1 : tensor<?x32xf32>, tensor<2x32xf32>) outs(%20 : tensor<?x2xf32>) {
          ^bb0(%in: f32, %in_2: f32, %out: f32):
            %23 = arith.mulf %in, %in_2 : f32
            %24 = arith.addf %out, %23 : f32
            linalg.yield %24 : f32
          } -> tensor<?x2xf32>
          %22 = linalg.generic {indexing_maps = [#map3, #map4, #map3], iterator_types = ["parallel", "parallel"]} ins(%21, %cst : tensor<?x2xf32>, tensor<2xf32>) outs(%19 : tensor<?x2xf32>) {
          ^bb0(%in: f32, %in_2: f32, %out: f32):
