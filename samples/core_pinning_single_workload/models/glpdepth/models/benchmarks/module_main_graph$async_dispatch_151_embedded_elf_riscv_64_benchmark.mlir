module {
  ...
  hal.executable private @main_graph$async_dispatch_151 {
    hal.executable.variant public @embedded_elf_riscv_64 target(<"llvm-cpu", "embedded-elf-riscv_64", {cpu = "spacemit-x60", cpu_features = "+m,+a,+f,+d,+c,+v,+zvl256b,+zba,+zbb,+zbc,+zbs,+zicbom,+zicboz,+zicbop,+zihintpause", data_layout = "e-m:e-p:64:64-i64:64-i128:128-n32:64-S128", iree.encoding.resolver = #iree_cpu.cpu_encoding_resolver<>, loop_vectorization = true, max_stack_allocation_size = 32768 : i64, native_vector_size = 32 : i64, target_abi = "lp64d", target_triple = "riscv64-unknown-unknown-eabi-elf"}>) {
      ...
      builtin.module {
        func.func @main_graph$async_dispatch_151_batch_mmt4d_8x7x2x32x7x32x1_f32() attributes {translation_info = #iree_codegen.translation_info<pipeline = Mmt4dTilingExpert>} {
          ...
          %9 = linalg.fill {lowering_config = #iree_cpu.lowering_config<vector_common_parallel = [1, 1, 1, 0, 7]>} ins(%cst : f32) outs(%8 : tensor<8x7x2x7x32xf32>) -> tensor<8x7x2x7x32xf32>
          %10 = linalg.batch_mmt4d {lowering_config = #iree_cpu.lowering_config<distribution = [1, 1, 2, 0, 0, 0, 0], vector_common_parallel = [1, 1, 1, 0, 7, 32, 0], vector_reduction = [0, 0, 0, 1, 0, 0, 1]>} ins(%6, %7 : tensor<8x7x32x7x1xf32>, tensor<8x2x32x32x1xf32>) outs(%9 : tensor<8x7x2x7x32xf32>) -> tensor<8x7x2x7x32xf32>
