#config = #iree_cpu.lowering_config<distribution = [8, 28, 35], vector_common_parallel = [1, 1, 7]>
...
module {
  ...
  hal.executable private @main_graph$async_dispatch_155 {
    hal.executable.variant public @embedded_elf_riscv_64 target(#executable_target_embedded_elf_riscv_64) {
      ...
      builtin.module {
        func.func @main_graph$async_dispatch_155_elementwise_broadcast_8x49x32_f32_pack() attributes {translation_info = #translation} {
          ...
          %4 = hal.interface.binding.subspan layout(#pipeline_layout) binding(1) alignment(64) offset(%c1080384) flags(Indirect) : !iree_tensor_ext.dispatch.tensor<writeonly:tensor<8x5x49x7x1xf32>>
          ...
          %8 = linalg.generic {indexing_maps = [#map], iterator_types = ["parallel", "parallel", "parallel"]} outs(%7 : tensor<8x49x32xf32>) attrs =  {lowering_config = #config} {
          ^bb0(%out: f32):
          ...
          %pack = linalg.pack %8 padding_value(%cst : f32) outer_dims_perm = [0, 2, 1] inner_dims_pos = [2, 1] inner_tiles = [7, 1] into %6 {lowering_config = #config1} : tensor<8x49x32xf32> -> tensor<8x5x49x7x1xf32>
