#config = #iree_cpu.lowering_config<distribution = [1, 4, 32], vector_common_parallel = [1, 1, 1]>
...
module {
  ...
  hal.executable private @main_graph$async_dispatch_158 {
    hal.executable.variant public @embedded_elf_riscv_64 target(#executable_target_embedded_elf_riscv_64) {
      ...
      builtin.module {
        func.func @main_graph$async_dispatch_158_pack_f32() attributes {translation_info = #translation} {
          %c577024 = arith.constant 577024 : index
          %c627200 = arith.constant 627200 : index
          %0 = hal.interface.binding.subspan layout(#pipeline_layout) binding(0) alignment(64) offset(%c577024) flags("ReadOnly|Indirect") : !iree_tensor_ext.dispatch.tensor<readonly:tensor<49x8x32xf32>>
          %1 = hal.interface.binding.subspan layout(#pipeline_layout) binding(1) alignment(64) offset(%c627200) flags(Indirect) : !iree_tensor_ext.dispatch.tensor<writeonly:tensor<7x8x32x7x1xf32>>
          ...
          %pack = linalg.pack %2 outer_dims_perm = [0, 1, 2] inner_dims_pos = [0, 2] inner_tiles = [7, 1] into %3 {lowering_config = #config} : tensor<49x8x32xf32> -> tensor<7x8x32x7x1xf32>
  ...
  util.global private mutable @main_graph$async_dispatch_158_embedded_elf_riscv_64_main_graph$async_dispatch_158_pack_f32_buffer : !hal.buffer
  util.initializer {
  ...
  util.func public @main_graph$async_dispatch_158_embedded_elf_riscv_64_main_graph$async_dispatch_158_pack_f32(%arg0: i32) attributes {iree.abi.stub, iree.reflection = {iree.benchmark = "dispatch"}} {
    ...
    %main_graph$async_dispatch_158_embedded_elf_riscv_64_main_graph$async_dispatch_158_pack_f32_buffer = util.global.load @main_graph$async_dispatch_158_embedded_elf_riscv_64_main_graph$async_dispatch_158_pack_f32_buffer : !hal.buffer
