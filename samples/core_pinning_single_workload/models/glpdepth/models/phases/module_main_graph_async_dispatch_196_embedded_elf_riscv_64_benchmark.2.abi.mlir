...
module {
  ...
  hal.executable private @main_graph$async_dispatch_196 {
    hal.executable.variant public @embedded_elf_riscv_64 target(#executable_target_embedded_elf_riscv_64) {
      ...
      builtin.module {
        func.func @main_graph$async_dispatch_196_elementwise_broadcast_50176_f32() attributes {translation_info = #translation} {
          ...
          %0 = hal.interface.binding.subspan layout(#pipeline_layout) binding(0) alignment(64) offset(%c639744) flags("ReadOnly|Indirect") : !iree_tensor_ext.dispatch.tensor<readonly:tensor<1x64x14x14xf32>>
          %1 = hal.interface.binding.subspan layout(#pipeline_layout) binding(1) alignment(64) offset(%c1404928) flags(Indirect) : !iree_tensor_ext.dispatch.tensor<writeonly:tensor<50176xf32>>
          ...
          %4 = linalg.generic {indexing_maps = [#map], iterator_types = ["parallel"]} outs(%3 : tensor<50176xf32>) attrs =  {lowering_config = #config} {
          ^bb0(%out: f32):
