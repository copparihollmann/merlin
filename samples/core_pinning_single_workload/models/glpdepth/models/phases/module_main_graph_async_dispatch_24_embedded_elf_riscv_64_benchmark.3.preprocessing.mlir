...
#config1 = #iree_cpu.lowering_config<distribution = [5, 2, 0, 0, 0, 0], vector_common_parallel = [1, 1, 0, 7, 32, 0], vector_reduction = [0, 0, 1, 0, 0, 1]>
...
module {
  ...
  hal.executable private @main_graph$async_dispatch_24 {
    hal.executable.variant public @embedded_elf_riscv_64 target(#executable_target_embedded_elf_riscv_64) {
      ...
      builtin.module {
        func.func @main_graph$async_dispatch_24_mmt4d_5x98x128x7x32x1_f32() attributes {translation_info = #translation} {
          ...
          %3 = hal.interface.binding.subspan layout(#pipeline_layout) binding(0) alignment(64) offset(%2) flags(ReadOnly) : !iree_tensor_ext.dispatch.tensor<readonly:tensor<5x128x7x1xf32>>
          %4 = hal.interface.binding.subspan layout(#pipeline_layout) binding(1) alignment(64) offset(%c1204224) flags("ReadOnly|Indirect") : !iree_tensor_ext.dispatch.tensor<readonly:tensor<98x128x32x1xf32>>
          %5 = hal.interface.binding.subspan layout(#pipeline_layout) binding(2) alignment(64) offset(%c0) flags(Indirect) : !iree_tensor_ext.dispatch.tensor<writeonly:tensor<5x98x7x32xf32>>
          ...
          %9 = linalg.fill {lowering_config = #config} ins(%cst : f32) outs(%8 : tensor<5x98x7x32xf32>) -> tensor<5x98x7x32xf32>
          %10 = linalg.mmt4d {lowering_config = #config1} ins(%6, %7 : tensor<5x128x7x1xf32>, tensor<98x128x32x1xf32>) outs(%9 : tensor<5x98x7x32xf32>) -> tensor<5x98x7x32xf32>
