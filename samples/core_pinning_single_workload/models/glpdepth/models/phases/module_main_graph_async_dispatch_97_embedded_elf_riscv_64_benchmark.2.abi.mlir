...
#config2 = #iree_cpu.lowering_config<distribution = [28, 0], vector_reduction = [0, 8]>
...
module {
  ...
  hal.executable private @main_graph$async_dispatch_97 {
    hal.executable.variant public @embedded_elf_riscv_64 target(#executable_target_embedded_elf_riscv_64) {
      ...
      builtin.module {
        func.func @main_graph$async_dispatch_97_reduction_784x64_f32() attributes {translation_info = #translation} {
          ...
          %1 = hal.interface.binding.subspan layout(#pipeline_layout) binding(0) alignment(64) offset(%c401408) flags("ReadOnly|Indirect") : !iree_tensor_ext.dispatch.tensor<readonly:tensor<784x64xf32>>
          %2 = hal.interface.binding.subspan layout(#pipeline_layout) binding(1) alignment(64) offset(%c802816) flags(Indirect) : !iree_tensor_ext.dispatch.tensor<writeonly:tensor<64x784xf32>>
          ...
          %7 = linalg.fill {lowering_config = #config} ins(%cst : f32) outs(%6 : tensor<784xf32>) -> tensor<784xf32>
          %8 = linalg.generic {indexing_maps = [#map, #map, #map1], iterator_types = ["parallel", "reduction"]} ins(%3, %4 : tensor<784x64xf32>, tensor<784x64xf32>) outs(%7 : tensor<784xf32>) attrs =  {lowering_config = #config1} {
          ...
          %9 = linalg.generic {indexing_maps = [#map, #map, #map1, #map1], iterator_types = ["parallel", "reduction"]} ins(%3, %4, %8 : tensor<784x64xf32>, tensor<784x64xf32>, tensor<784xf32>) outs(%7 : tensor<784xf32>) attrs =  {lowering_config = #config2} {
          ...
          %10 = linalg.generic {indexing_maps = [#map2, #map2, #map3, #map3, #map], iterator_types = ["parallel", "parallel"]} ins(%3, %4, %8, %9 : tensor<784x64xf32>, tensor<784x64xf32>, tensor<784xf32>, tensor<784xf32>) outs(%5 : tensor<64x784xf32>) attrs =  {lowering_config = #config3} {
  ...
  util.global private mutable @main_graph$async_dispatch_97_embedded_elf_riscv_64_main_graph$async_dispatch_97_reduction_784x64_f32_buffer : !hal.buffer
  util.initializer {
  ...
  util.func public @main_graph$async_dispatch_97_embedded_elf_riscv_64_main_graph$async_dispatch_97_reduction_784x64_f32(%arg0: i32) attributes {iree.abi.stub, iree.reflection = {iree.benchmark = "dispatch"}} {
    ...
    %main_graph$async_dispatch_97_embedded_elf_riscv_64_main_graph$async_dispatch_97_reduction_784x64_f32_buffer = util.global.load @main_graph$async_dispatch_97_embedded_elf_riscv_64_main_graph$async_dispatch_97_reduction_784x64_f32_buffer : !hal.buffer
