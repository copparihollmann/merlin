#config = #iree_cpu.lowering_config<distribution = [1, 49], vector_common_parallel = [1, 1]>
...
module {
  ...
  hal.executable private @main_graph$async_dispatch_13 {
    hal.executable.variant public @embedded_elf_riscv_64 target(#executable_target_embedded_elf_riscv_64) {
      ...
      builtin.module {
        func.func @main_graph$async_dispatch_13_pack_f32() attributes {translation_info = #translation} {
          ...
          %6 = hal.interface.binding.subspan layout(#pipeline_layout) binding(1) alignment(64) offset(%4#1) flags(Indirect) : !iree_tensor_ext.dispatch.tensor<writeonly:tensor<98x49x32x1xf32>>
          ...
          %pack = linalg.pack %7 outer_dims_perm = [0, 1] inner_dims_pos = [0, 1] inner_tiles = [32, 1] into %8 {lowering_config = #config} : tensor<3136x49xf32> -> tensor<98x49x32x1xf32>
