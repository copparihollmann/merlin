...
module {
  ...
  hal.executable private @main_graph$async_dispatch_198 {
    hal.executable.variant public @embedded_elf_riscv_64 target(#executable_target_embedded_elf_riscv_64) {
      ...
      builtin.module {
        func.func @main_graph$async_dispatch_198_slow_memcpy() attributes {translation_info = #translation} {
          %c1204224 = arith.constant 1204224 : index
          %c1605632 = arith.constant 1605632 : index
          %0 = hal.interface.binding.subspan layout(#pipeline_layout) binding(0) alignment(64) offset(%c1204224) flags("ReadOnly|Indirect") : memref<128x28x28xf32, strided<[784, 28, 1], offset: ?>>
          %assume_align = memref.assume_alignment %0, 64 : memref<128x28x28xf32, strided<[784, 28, 1], offset: ?>>
          %1 = hal.interface.binding.subspan layout(#pipeline_layout) binding(1) alignment(64) offset(%c1605632) flags(Indirect) : memref<128x30x30xf32, strided<[900, 30, 1], offset: ?>>
          ...
          linalg.generic {indexing_maps = [#map, #map], iterator_types = ["parallel", "parallel", "parallel"]} ins(%assume_align : memref<128x28x28xf32, strided<[784, 28, 1], offset: ?>>) outs(%subview : memref<128x28x28xf32, strided<[900, 30, 1], offset: ?>>) attrs =  {lowering_config = #config} {
          ^bb0(%in: f32, %out: f32):
            linalg.yield %in : f32
          }
          return
