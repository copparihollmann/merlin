...
#config1 = #iree_cpu.lowering_config<distribution = [1, 1, 2, 0, 0, 0, 0], vector_common_parallel = [1, 1, 1, 0, 7, 32, 0], vector_reduction = [0, 0, 0, 1, 0, 0, 1]>
...
module {
  ...
  hal.executable private @main_graph$async_dispatch_156 {
    hal.executable.variant public @embedded_elf_riscv_64 target(#executable_target_embedded_elf_riscv_64) {
      ...
      builtin.module {
        func.func @main_graph$async_dispatch_156_batch_mmt4d_8x5x2x49x7x32x1_f32() attributes {translation_info = #translation} {
          ...
          %3 = hal.interface.binding.subspan layout(#pipeline_layout) binding(0) alignment(64) offset(%c1080384) flags("ReadOnly|Indirect") : !iree_tensor_ext.dispatch.tensor<readonly:tensor<8x5x49x7x1xf32>>
          %4 = hal.interface.binding.subspan layout(#pipeline_layout) binding(0) alignment(64) offset(%2) flags("ReadOnly|Indirect") : !iree_tensor_ext.dispatch.tensor<readonly:tensor<8x2x49x32x1xf32>>
          %5 = hal.interface.binding.subspan layout(#pipeline_layout) binding(1) alignment(64) offset(%c1003520) flags(Indirect) : !iree_tensor_ext.dispatch.tensor<writeonly:tensor<8x5x2x7x32xf32>>
          ...
          %9 = linalg.fill {lowering_config = #config} ins(%cst : f32) outs(%8 : tensor<8x5x2x7x32xf32>) -> tensor<8x5x2x7x32xf32>
          %10 = linalg.batch_mmt4d {lowering_config = #config1} ins(%6, %7 : tensor<8x5x49x7x1xf32>, tensor<8x2x49x32x1xf32>) outs(%9 : tensor<8x5x2x7x32xf32>) -> tensor<8x5x2x7x32xf32>
