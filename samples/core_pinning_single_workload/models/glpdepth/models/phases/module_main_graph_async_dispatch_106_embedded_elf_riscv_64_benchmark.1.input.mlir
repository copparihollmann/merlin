...
module {
  ...
  hal.executable private @main_graph$async_dispatch_106 {
    hal.executable.variant public @embedded_elf_riscv_64 target(#executable_target_embedded_elf_riscv_64) {
      ...
      builtin.module {
        func.func @main_graph$async_dispatch_106_batch_mmt4d_5x7x7x32x7x32x1_f32() attributes {translation_info = #translation} {
          ...
          %4:2 = util.assume.int 
            ...
            : index, index
          %5 = hal.interface.binding.subspan layout(#pipeline_layout) binding(0) alignment(64) offset(%4#0) flags("ReadOnly|Indirect") : !iree_tensor_ext.dispatch.tensor<readonly:tensor<5x7x32x7x1xf32>>
          %6 = hal.interface.binding.subspan layout(#pipeline_layout) binding(0) alignment(64) offset(%4#1) flags("ReadOnly|Indirect") : !iree_tensor_ext.dispatch.tensor<readonly:tensor<5x7x32x32x1xf32>>
          %7 = hal.interface.binding.subspan layout(#pipeline_layout) binding(1) alignment(64) offset(%c1003520) flags(Indirect) : !iree_tensor_ext.dispatch.tensor<writeonly:tensor<5x7x7x7x32xf32>>
          ...
          %11 = linalg.fill {lowering_config = #config} ins(%cst : f32) outs(%10 : tensor<5x7x7x7x32xf32>) -> tensor<5x7x7x7x32xf32>
          %12 = linalg.batch_mmt4d {lowering_config = #config1} ins(%8, %9 : tensor<5x7x32x7x1xf32>, tensor<5x7x32x32x1xf32>) outs(%11 : tensor<5x7x7x7x32xf32>) -> tensor<5x7x7x7x32xf32>
  ...
  util.global private mutable @main_graph$async_dispatch_106_embedded_elf_riscv_64_main_graph$async_dispatch_106_batch_mmt4d_5x7x7x32x7x32x1_f32_buffer : !hal.buffer
  util.initializer {
  ...
  util.func public @main_graph$async_dispatch_106_embedded_elf_riscv_64_main_graph$async_dispatch_106_batch_mmt4d_5x7x7x32x7x32x1_f32(%arg0: i32) attributes {iree.abi.stub, iree.reflection = {iree.benchmark = "dispatch"}} {
    ...
    %main_graph$async_dispatch_106_embedded_elf_riscv_64_main_graph$async_dispatch_106_batch_mmt4d_5x7x7x32x7x32x1_f32_buffer = util.global.load @main_graph$async_dispatch_106_embedded_elf_riscv_64_main_graph$async_dispatch_106_batch_mmt4d_5x7x7x32x7x32x1_f32_buffer : !hal.buffer
