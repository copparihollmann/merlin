#config = #iree_cpu.lowering_config<distribution = [5, 32, 49], vector_common_parallel = [1, 1, 7]>
...
module {
  ...
  hal.executable private @main_graph$async_dispatch_105 {
    hal.executable.variant public @embedded_elf_riscv_64 target(#executable_target_embedded_elf_riscv_64) {
      ...
      builtin.module {
        func.func @main_graph$async_dispatch_105_elementwise_broadcast_5x32x49_f32_pack() attributes {translation_info = #translation} {
          ...
          %6 = hal.interface.binding.subspan layout(#pipeline_layout) binding(1) alignment(64) offset(%4#1) flags(Indirect) : !iree_tensor_ext.dispatch.tensor<writeonly:tensor<5x7x32x7x1xf32>>
          ...
          %10 = linalg.generic {indexing_maps = [#map], iterator_types = ["parallel", "parallel", "parallel"]} outs(%9 : tensor<5x32x49xf32>) attrs =  {lowering_config = #config} {
          ^bb0(%out: f32):
          ...
          %pack = linalg.pack %10 outer_dims_perm = [0, 2, 1] inner_dims_pos = [2, 1] inner_tiles = [7, 1] into %8 {lowering_config = #config1} : tensor<5x32x49xf32> -> tensor<5x7x32x7x1xf32>
  ...
  util.global private mutable @main_graph$async_dispatch_105_embedded_elf_riscv_64_main_graph$async_dispatch_105_elementwise_broadcast_5x32x49_f32_pack_buffer : !hal.buffer
  util.initializer {
  ...
  util.func public @main_graph$async_dispatch_105_embedded_elf_riscv_64_main_graph$async_dispatch_105_elementwise_broadcast_5x32x49_f32_pack(%arg0: i32) attributes {iree.abi.stub, iree.reflection = {iree.benchmark = "dispatch"}} {
    ...
    %main_graph$async_dispatch_105_embedded_elf_riscv_64_main_graph$async_dispatch_105_elementwise_broadcast_5x32x49_f32_pack_buffer = util.global.load @main_graph$async_dispatch_105_embedded_elf_riscv_64_main_graph$async_dispatch_105_elementwise_broadcast_5x32x49_f32_pack_buffer : !hal.buffer
