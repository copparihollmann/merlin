...
module {
  ...
  hal.executable private @main_graph$async_dispatch_200 {
    hal.executable.variant public @embedded_elf_riscv_64 target(#executable_target_embedded_elf_riscv_64) {
      hal.executable.export public @main_graph$async_dispatch_200_conv_32x28x28x64x3x3_f32 ordinal(0) layout(#pipeline_layout) count(%arg0: !hal.device) -> (index, index, index) {
      ...
      builtin.module attributes {llvm.data_layout = "e-m:e-p:64:64-i64:64-i128:128-n32:64-S128", llvm.target_triple = "riscv64-unknown-unknown-eabi-elf"} {
        llvm.mlir.global private constant @__constant_32xf32(dense<[-0.0414385311, 0.0264963675, -0.00167072972, 0.0339116529, 0.04004208, 0.0039563179, 0.0185149722, -0.0248472393, 0.0364923552, 0.018306369, -0.00236402266, -0.0350675136, -9.58010787E-4, 0.0370157696, 0.00903628673, 0.0186075885, -0.0124377534, 0.0385294817, 0.0389215425, 0.0128973229, -0.00929349474, 0.0304209404, 0.0166775249, 0.0234518182, -0.00907016266, 0.00185304449, 0.0270909462, 0.0381552428, -0.0310743526, -0.0324764252, -0.0347734056, -0.0120343165]> : tensor<32xf32>) {addr_space = 0 : i32, alignment = 64 : i64, sym_visibility = "private"} : !llvm.array<32 x f32>
        llvm.func @main_graph$async_dispatch_200_conv_32x28x28x64x3x3_f32(%arg0: !llvm.ptr {llvm.align = 16 : i64, llvm.noalias, llvm.nonnull, llvm.noundef}, %arg1: !llvm.ptr {llvm.align = 16 : i64, llvm.noalias, llvm.nonnull, llvm.noundef}, %arg2: !llvm.ptr {llvm.align = 16 : i64, llvm.noalias, llvm.nonnull, llvm.noundef}) -> i32 {
          ...
          %24 = llvm.mlir.constant(689920 : index) : i64
          %25 = llvm.mlir.constant(9025792 : index) : i64
          %26 = llvm.mlir.constant(401408 : index) : i64
          %27 = llvm.getelementptr %10[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<32 x f32>
          %28 = llvm.alloca %12 x f32 {alignment = 64 : i64} : (i64) -> !llvm.ptr
          ...
          %52 = llvm.sdiv %51, %20 : i64
          %53 = llvm.mul %52, %20 : i64
          ...
          %59 = llvm.srem %51, %20 : i64
          %60 = llvm.icmp "slt" %59, %19 : i64
          %61 = llvm.add %59, %20 overflow<nsw> : i64
          %62 = llvm.select %60, %61, %59 : i1, i64
          %63 = llvm.mul %58, %15 overflow<nsw> : i64
          %64 = llvm.mul %62, %14 overflow<nsw> : i64
          llvm.br ^bb1(%19 : i64)
        ...
        ^bb3(%70: i64):  // 2 preds: ^bb2, ^bb18
          ...
          llvm.cond_br %71, ^bb4(%19 : i64), ^bb19
        ^bb4(%72: i64):  // 2 preds: ^bb3, ^bb17
          %73 = llvm.icmp "slt" %72, %13 : i64
          llvm.cond_br %73, ^bb5, ^bb18
        ^bb5:  // pred: ^bb4
          %74 = llvm.sub %13, %72 : i64
          ...
          %80 = llvm.icmp "sgt" %79, %22 : vector<8xi32>
          %81 = llvm.mul %19, %12 : i64
          %82 = llvm.add %81, %81 : i64
          %83 = llvm.add %82, %19 : i64
          %84 = llvm.getelementptr %28[%83] : (!llvm.ptr, i64) -> !llvm.ptr, f32
          llvm.intr.masked.store %23, %84, %80 {alignment = 4 : i32} : vector<8xf32>, vector<8xi1> into !llvm.ptr
          llvm.br ^bb6(%19 : i64)
        ^bb6(%85: i64):  // 2 preds: ^bb5, ^bb14
          %86 = llvm.icmp "slt" %85, %18 : i64
          llvm.cond_br %86, ^bb7(%19 : i64), ^bb15
        ...
        ^bb9(%91: i64):  // 2 preds: ^bb8, ^bb12
          ...
          llvm.cond_br %92, ^bb10(%19 : i64), ^bb13
        ...
        ^bb11:  // pred: ^bb10
          ...
          %106 = llvm.mul %87, %17 overflow<nsw, nuw> : i64
          ...
          %111 = llvm.mul %19, %12 overflow<nsw, nuw> : i64
          ...
          %118 = llvm.add %93, %16 : i64
          llvm.br ^bb10(%118 : i64)
        ^bb12:  // pred: ^bb10
          %119 = llvm.add %91, %16 : i64
          llvm.br ^bb9(%119 : i64)
        ^bb13:  // pred: ^bb9
          %120 = llvm.add %87, %16 : i64
          llvm.br ^bb7(%120 : i64)
        ^bb14:  // pred: ^bb7
          %121 = llvm.add %85, %16 : i64
          llvm.br ^bb6(%121 : i64)
        ^bb15:  // pred: ^bb6
          %122 = llvm.icmp "sgt" %76, %19 : i64
          llvm.cond_br %122, ^bb16, ^bb17
        ^bb16:  // pred: ^bb15
          %123 = llvm.intr.masked.load %84, %80, %21 {alignment = 4 : i32} : (!llvm.ptr, vector<8xi1>, vector<8xf32>) -> vector<8xf32>
          %124 = llvm.extractelement %69[%0 : i64] : vector<1xf32>
          %125 = llvm.insertelement %124, %21[%1 : i32] : vector<8xf32>
          %126 = llvm.shufflevector %125, %21 [0, 0, 0, 0, 0, 0, 0, 0] : vector<8xf32> 
          %127 = llvm.fadd %123, %126 {fastmathFlags = #llvm.fastmath<contract>} : vector<8xf32>
          %128 = llvm.fcmp "ugt" %127, %23 : vector<8xf32>
          %129 = llvm.select %128, %127, %23 : vector<8xi1>, vector<8xf32>
          %130 = llvm.add %64, %70 : i64
          %131 = llvm.add %130, %16 : i64
          %132 = llvm.add %72, %16 : i64
        ...
        ^bb17:  // 2 preds: ^bb15, ^bb16
          %138 = llvm.add %72, %12 : i64
          llvm.br ^bb4(%138 : i64)
        ^bb18:  // pred: ^bb4
          %139 = llvm.add %70, %16 : i64
          llvm.br ^bb3(%139 : i64)
        ^bb19:  // pred: ^bb3
          %140 = llvm.add %65, %16 : i64
          llvm.br ^bb1(%140 : i64)
        ^bb20:  // pred: ^bb1
          llvm.return %1 : i32
        }
  ...
  util.global private @main_graph$async_dispatch_200_embedded_elf_riscv_64_main_graph$async_dispatch_200_conv_32x28x28x64x3x3_f32_buffer : !hal.buffer
  util.initializer {
    ...
    util.global.store %buffer, @main_graph$async_dispatch_200_embedded_elf_riscv_64_main_graph$async_dispatch_200_conv_32x28x28x64x3x3_f32_buffer : !hal.buffer
    util.return
  }
  util.func public @main_graph$async_dispatch_200_embedded_elf_riscv_64_main_graph$async_dispatch_200_conv_32x28x28x64x3x3_f32(%arg0: i32) attributes {iree.abi.stub, iree.reflection = {iree.benchmark = "dispatch"}} {
    ...
    %main_graph$async_dispatch_200_embedded_elf_riscv_64_main_graph$async_dispatch_200_conv_32x28x28x64x3x3_f32_buffer = util.global.load immutable @main_graph$async_dispatch_200_embedded_elf_riscv_64_main_graph$async_dispatch_200_conv_32x28x28x64x3x3_f32_buffer : !hal.buffer
    %1 = arith.index_cast %arg0 : i32 to index
    %device, %queue_affinity = hal.device.resolve on(#hal.device.affinity<@__device_0>) : !hal.device, i64
    %cmd = hal.command_buffer.create device(%device : !hal.device) mode("OneShot|AllowInlineExecution") categories(Dispatch) affinity(%queue_affinity) : !hal.command_buffer
    %workgroup_x, %workgroup_y, %workgroup_z = hal.executable.calculate_workgroups device(%device : !hal.device) target(@main_graph$async_dispatch_200::@embedded_elf_riscv_64::@main_graph$async_dispatch_200_conv_32x28x28x64x3x3_f32) : index, index, index
    %exe = hal.executable.lookup device(%device : !hal.device) executable(@main_graph$async_dispatch_200) : !hal.executable
    %ordinal = hal.executable.export.ordinal target(@main_graph$async_dispatch_200::@embedded_elf_riscv_64::@main_graph$async_dispatch_200_conv_32x28x28x64x3x3_f32) : index
    cf.br ^bb1(%c0 : index)
  ...
  ^bb2:  // pred: ^bb1
    hal.command_buffer.dispatch<%cmd : !hal.command_buffer> target(%exe : !hal.executable)[%ordinal] workgroups([%workgroup_x, %workgroup_y, %workgroup_z]) bindings([
      (%main_graph$async_dispatch_200_embedded_elf_riscv_64_main_graph$async_dispatch_200_conv_32x28x28x64x3x3_f32_buffer : !hal.buffer)[%c0, %c32172032], 
      (%main_graph$async_dispatch_200_embedded_elf_riscv_64_main_graph$async_dispatch_200_conv_32x28x28x64x3x3_f32_buffer : !hal.buffer)[%c32172032, %c14611584], 
      (%main_graph$async_dispatch_200_embedded_elf_riscv_64_main_graph$async_dispatch_200_conv_32x28x28x64x3x3_f32_buffer : !hal.buffer)[%c46783744, %c32172032]
    ]) flags("None")
