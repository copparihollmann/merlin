#config = #iree_cpu.lowering_config<distribution = [64, 42], vector_common_parallel = [32, 7]>
...
module {
  ...
  hal.executable private @main_graph$async_dispatch_115 {
    hal.executable.variant public @embedded_elf_riscv_64 target(#executable_target_embedded_elf_riscv_64) {
      ...
      builtin.module {
        func.func @main_graph$async_dispatch_115_unpack_f32() attributes {translation_info = #translation} {
          ...
          %4:2 = util.assume.int 
            ...
            : index, index
          %5 = hal.interface.binding.subspan layout(#pipeline_layout) binding(0) alignment(64) offset(%4#0) flags("ReadOnly|Indirect") : !iree_tensor_ext.dispatch.tensor<readonly:tensor<23x7x7x32xf32>>
          %6 = hal.interface.binding.subspan layout(#pipeline_layout) binding(1) alignment(64) offset(%4#1) flags(Indirect) : !iree_tensor_ext.dispatch.tensor<writeonly:tensor<196x160xf32>>
          ...
          %unpack = linalg.unpack %7 outer_dims_perm = [1, 0] inner_dims_pos = [1, 0] inner_tiles = [7, 32] into %8 {lowering_config = #config} : tensor<23x7x7x32xf32> -> tensor<196x160xf32>
  ...
  util.global private mutable @main_graph$async_dispatch_115_embedded_elf_riscv_64_main_graph$async_dispatch_115_unpack_f32_buffer : !hal.buffer
  util.initializer {
  ...
  util.func public @main_graph$async_dispatch_115_embedded_elf_riscv_64_main_graph$async_dispatch_115_unpack_f32(%arg0: i32) attributes {iree.abi.stub, iree.reflection = {iree.benchmark = "dispatch"}} {
    ...
    %main_graph$async_dispatch_115_embedded_elf_riscv_64_main_graph$async_dispatch_115_unpack_f32_buffer = util.global.load @main_graph$async_dispatch_115_embedded_elf_riscv_64_main_graph$async_dispatch_115_unpack_f32_buffer : !hal.buffer
