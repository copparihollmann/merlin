#config = #iree_cpu.lowering_config<distribution = [32, 14, 14], vector_common_parallel = [1, 1, 8]>
...
module {
  ...
  hal.executable private @main_graph$async_dispatch_145 {
    hal.executable.variant public @embedded_elf_riscv_64 target(#executable_target_embedded_elf_riscv_64) {
      ...
      builtin.module {
        func.func @main_graph$async_dispatch_145_slow_memcpy() attributes {translation_info = #translation} {
          %c401408 = arith.constant 401408 : index
          %c1128960 = arith.constant 1128960 : index
          %0 = hal.interface.binding.subspan layout(#pipeline_layout) binding(0) alignment(64) offset(%c401408) flags("ReadOnly|Indirect") : memref<160x14x14xf32, strided<[196, 14, 1], offset: ?>>
          %assume_align = memref.assume_alignment %0, 64 : memref<160x14x14xf32, strided<[196, 14, 1], offset: ?>>
          %1 = hal.interface.binding.subspan layout(#pipeline_layout) binding(1) alignment(64) offset(%c1128960) flags(Indirect) : memref<160x16x16xf32, strided<[256, 16, 1], offset: ?>>
          ...
          linalg.generic {indexing_maps = [#map, #map], iterator_types = ["parallel", "parallel", "parallel"]} ins(%assume_align : memref<160x14x14xf32, strided<[196, 14, 1], offset: ?>>) outs(%subview : memref<160x14x14xf32, strided<[256, 16, 1], offset: ?>>) attrs =  {lowering_config = #config} {
          ^bb0(%in: f32, %out: f32):
            linalg.yield %in : f32
          }
          return
