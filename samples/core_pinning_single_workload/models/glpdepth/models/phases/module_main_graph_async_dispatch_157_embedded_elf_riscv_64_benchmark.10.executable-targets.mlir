...
module {
  ...
  hal.executable private @main_graph$async_dispatch_157 {
    hal.executable.variant public @embedded_elf_riscv_64 target(#executable_target_embedded_elf_riscv_64) {
      hal.executable.export public @main_graph$async_dispatch_157_unpack_f32 ordinal(0) layout(#pipeline_layout) count(%arg0: !hal.device) -> (index, index, index) {
      ...
      builtin.module attributes {llvm.data_layout = "e-m:e-p:64:64-i64:64-i128:128-n32:64-S128", llvm.target_triple = "riscv64-unknown-unknown-eabi-elf"} {
        llvm.func @main_graph$async_dispatch_157_unpack_f32(%arg0: !llvm.ptr {llvm.align = 16 : i64, llvm.noalias, llvm.nonnull, llvm.noundef}, %arg1: !llvm.ptr {llvm.align = 16 : i64, llvm.noalias, llvm.nonnull, llvm.noundef}, %arg2: !llvm.ptr {llvm.align = 16 : i64, llvm.noalias, llvm.nonnull, llvm.noundef}) -> i32 {
          %0 = llvm.mlir.constant(0 : i32) : i32
          %1 = llvm.mlir.poison : vector<7xi64>
          %2 = llvm.mlir.constant(256 : index) : i64
          %3 = llvm.mlir.constant(64 : index) : i64
          %4 = llvm.mlir.constant(true) : i1
          %5 = llvm.mlir.constant(2240 : index) : i64
          ...
          %33 = llvm.mlir.constant(dense<false> : vector<7xi1>) : vector<7xi1>
          %34 = llvm.mlir.constant(dense<[0, 1, 2, 3, 4, 5, 6]> : vector<7xi64>) : vector<7xi64>
          ...
          %50 = llvm.mlir.constant(577024 : index) : i64
          ...
          %68 = llvm.mul %66, %35 overflow<nsw> : i64
        ...
        ^bb5:  // pred: ^bb4
          ...
          %192 = llvm.icmp "sgt" %191, %34 : vector<7xi64>
          %193 = llvm.icmp "sgt" %82, %48 : i64
          %194 = llvm.select %193, %192, %33 : i1, vector<7xi1>
          %195 = llvm.icmp "sgt" %82, %45 : i64
          %196 = llvm.select %195, %192, %33 : i1, vector<7xi1>
          %197 = llvm.icmp "sgt" %82, %43 : i64
          %198 = llvm.select %197, %192, %33 : i1, vector<7xi1>
          %199 = llvm.icmp "sgt" %82, %42 : i64
          %200 = llvm.select %199, %192, %33 : i1, vector<7xi1>
          %201 = llvm.icmp "sgt" %82, %41 : i64
          %202 = llvm.select %201, %192, %33 : i1, vector<7xi1>
          %203 = llvm.icmp "sgt" %82, %40 : i64
          %204 = llvm.select %203, %192, %33 : i1, vector<7xi1>
          %205 = llvm.icmp "sgt" %82, %39 : i64
          %206 = llvm.select %205, %192, %33 : i1, vector<7xi1>
          %207 = llvm.icmp "sgt" %82, %44 : i64
          %208 = llvm.select %207, %192, %33 : i1, vector<7xi1>
          %209 = llvm.icmp "sgt" %82, %47 : i64
          %210 = llvm.select %209, %192, %33 : i1, vector<7xi1>
          %211 = llvm.icmp "sgt" %82, %32 : i64
          %212 = llvm.select %211, %192, %33 : i1, vector<7xi1>
          %213 = llvm.icmp "sgt" %82, %31 : i64
          %214 = llvm.select %213, %192, %33 : i1, vector<7xi1>
          %215 = llvm.icmp "sgt" %82, %30 : i64
          %216 = llvm.select %215, %192, %33 : i1, vector<7xi1>
          %217 = llvm.icmp "sgt" %82, %29 : i64
          %218 = llvm.select %217, %192, %33 : i1, vector<7xi1>
          %219 = llvm.icmp "sgt" %82, %28 : i64
          %220 = llvm.select %219, %192, %33 : i1, vector<7xi1>
          %221 = llvm.icmp "sgt" %82, %27 : i64
          %222 = llvm.select %221, %192, %33 : i1, vector<7xi1>
          %223 = llvm.icmp "sgt" %82, %26 : i64
          %224 = llvm.select %223, %192, %33 : i1, vector<7xi1>
          %225 = llvm.icmp "sgt" %82, %25 : i64
          %226 = llvm.select %225, %192, %33 : i1, vector<7xi1>
          %227 = llvm.icmp "sgt" %82, %24 : i64
          %228 = llvm.select %227, %192, %33 : i1, vector<7xi1>
          %229 = llvm.icmp "sgt" %82, %23 : i64
          %230 = llvm.select %229, %192, %33 : i1, vector<7xi1>
          %231 = llvm.icmp "sgt" %82, %22 : i64
          %232 = llvm.select %231, %192, %33 : i1, vector<7xi1>
          %233 = llvm.icmp "sgt" %82, %21 : i64
          %234 = llvm.select %233, %192, %33 : i1, vector<7xi1>
          %235 = llvm.icmp "sgt" %82, %20 : i64
          %236 = llvm.select %235, %192, %33 : i1, vector<7xi1>
          %237 = llvm.icmp "sgt" %82, %19 : i64
          %238 = llvm.select %237, %192, %33 : i1, vector<7xi1>
          %239 = llvm.icmp "sgt" %82, %18 : i64
          %240 = llvm.select %239, %192, %33 : i1, vector<7xi1>
          %241 = llvm.icmp "sgt" %82, %17 : i64
          %242 = llvm.select %241, %192, %33 : i1, vector<7xi1>
          %243 = llvm.icmp "sgt" %82, %16 : i64
          %244 = llvm.select %243, %192, %33 : i1, vector<7xi1>
          %245 = llvm.icmp "sgt" %82, %15 : i64
          %246 = llvm.select %245, %192, %33 : i1, vector<7xi1>
          %247 = llvm.icmp "sgt" %82, %14 : i64
          %248 = llvm.select %247, %192, %33 : i1, vector<7xi1>
          %249 = llvm.icmp "sgt" %82, %13 : i64
          %250 = llvm.select %249, %192, %33 : i1, vector<7xi1>
          %251 = llvm.icmp "sgt" %82, %12 : i64
          %252 = llvm.select %251, %192, %33 : i1, vector<7xi1>
          %253 = llvm.icmp "sgt" %82, %11 : i64
          %254 = llvm.select %253, %192, %33 : i1, vector<7xi1>
          %255 = llvm.icmp "sgt" %82, %10 : i64
          %256 = llvm.select %255, %192, %33 : i1, vector<7xi1>
  ...
  util.global private @main_graph$async_dispatch_157_embedded_elf_riscv_64_main_graph$async_dispatch_157_unpack_f32_buffer : !hal.buffer
  util.initializer {
    ...
    util.global.store %buffer, @main_graph$async_dispatch_157_embedded_elf_riscv_64_main_graph$async_dispatch_157_unpack_f32_buffer : !hal.buffer
    util.return
  }
  util.func public @main_graph$async_dispatch_157_embedded_elf_riscv_64_main_graph$async_dispatch_157_unpack_f32(%arg0: i32) attributes {iree.abi.stub, iree.reflection = {iree.benchmark = "dispatch"}} {
    %c0 = arith.constant 0 : index
    %c32172032 = arith.constant 32172032 : index
    %c1 = arith.constant 1 : index
    %0 = util.null : !hal.fence
    %c-1_i32 = arith.constant -1 : i32
    %main_graph$async_dispatch_157_embedded_elf_riscv_64_main_graph$async_dispatch_157_unpack_f32_buffer = util.global.load immutable @main_graph$async_dispatch_157_embedded_elf_riscv_64_main_graph$async_dispatch_157_unpack_f32_buffer : !hal.buffer
    %1 = arith.index_cast %arg0 : i32 to index
    %device, %queue_affinity = hal.device.resolve on(#hal.device.affinity<@__device_0>) : !hal.device, i64
    %cmd = hal.command_buffer.create device(%device : !hal.device) mode("OneShot|AllowInlineExecution") categories(Dispatch) affinity(%queue_affinity) : !hal.command_buffer
    %workgroup_x, %workgroup_y, %workgroup_z = hal.executable.calculate_workgroups device(%device : !hal.device) target(@main_graph$async_dispatch_157::@embedded_elf_riscv_64::@main_graph$async_dispatch_157_unpack_f32) : index, index, index
    %exe = hal.executable.lookup device(%device : !hal.device) executable(@main_graph$async_dispatch_157) : !hal.executable
    %ordinal = hal.executable.export.ordinal target(@main_graph$async_dispatch_157::@embedded_elf_riscv_64::@main_graph$async_dispatch_157_unpack_f32) : index
    cf.br ^bb1(%c0 : index)
  ...
  ^bb2:  // pred: ^bb1
    hal.command_buffer.dispatch<%cmd : !hal.command_buffer> target(%exe : !hal.executable)[%ordinal] workgroups([%workgroup_x, %workgroup_y, %workgroup_z]) bindings([
      (%main_graph$async_dispatch_157_embedded_elf_riscv_64_main_graph$async_dispatch_157_unpack_f32_buffer : !hal.buffer)[%c0, %c32172032], 
      (%main_graph$async_dispatch_157_embedded_elf_riscv_64_main_graph$async_dispatch_157_unpack_f32_buffer : !hal.buffer)[%c32172032, %c32172032]
    ]) flags("None")
