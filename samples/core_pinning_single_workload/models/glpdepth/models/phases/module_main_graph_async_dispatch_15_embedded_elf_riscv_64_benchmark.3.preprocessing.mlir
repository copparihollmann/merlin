...
module {
  ...
  hal.executable private @main_graph$async_dispatch_15 {
    hal.executable.variant public @embedded_elf_riscv_64 target(#executable_target_embedded_elf_riscv_64) {
      ...
      builtin.module {
        func.func @main_graph$async_dispatch_15_mmt4d_5x98x49x7x32x1_f32() attributes {translation_info = #translation} {
          ...
          %6:3 = util.assume.int 
            ...
            : index, index, index
          %7 = hal.interface.binding.subspan layout(#pipeline_layout) binding(0) alignment(64) offset(%6#0) flags("ReadOnly|Indirect") : !iree_tensor_ext.dispatch.tensor<readonly:tensor<5x49x7x1xf32>>
          %8 = hal.interface.binding.subspan layout(#pipeline_layout) binding(0) alignment(64) offset(%6#1) flags("ReadOnly|Indirect") : !iree_tensor_ext.dispatch.tensor<readonly:tensor<98x49x32x1xf32>>
          %9 = hal.interface.binding.subspan layout(#pipeline_layout) binding(1) alignment(64) offset(%6#2) flags(Indirect) : !iree_tensor_ext.dispatch.tensor<writeonly:tensor<5x98x7x32xf32>>
          ...
          %13 = linalg.fill {lowering_config = #config} ins(%cst : f32) outs(%12 : tensor<5x98x7x32xf32>) -> tensor<5x98x7x32xf32>
          %14 = linalg.mmt4d {lowering_config = #config1} ins(%10, %11 : tensor<5x49x7x1xf32>, tensor<98x49x32x1xf32>) outs(%13 : tensor<5x98x7x32xf32>) -> tensor<5x98x7x32xf32>
  ...
  util.global private mutable @main_graph$async_dispatch_15_embedded_elf_riscv_64_main_graph$async_dispatch_15_mmt4d_5x98x49x7x32x1_f32_buffer : !hal.buffer
  util.initializer {
  ...
  util.func public @main_graph$async_dispatch_15_embedded_elf_riscv_64_main_graph$async_dispatch_15_mmt4d_5x98x49x7x32x1_f32(%arg0: i32) attributes {iree.abi.stub, iree.reflection = {iree.benchmark = "dispatch"}} {
    ...
    %main_graph$async_dispatch_15_embedded_elf_riscv_64_main_graph$async_dispatch_15_mmt4d_5x98x49x7x32x1_f32_buffer = util.global.load @main_graph$async_dispatch_15_embedded_elf_riscv_64_main_graph$async_dispatch_15_mmt4d_5x98x49x7x32x1_f32_buffer : !hal.buffer
