...
module {
  ...
  hal.executable private @main_graph$async_dispatch_62 {
    hal.executable.variant public @embedded_elf_riscv_64 target(#executable_target_embedded_elf_riscv_64) {
      ...
      builtin.module {
        func.func @main_graph$async_dispatch_62_pack_f32() attributes {translation_info = #translation} {
          %cst = arith.constant 0.000000e+00 : f32
          %c1003520 = arith.constant 1003520 : index
          %c1310848 = arith.constant 1310848 : index
          %0 = hal.interface.binding.subspan layout(#pipeline_layout) binding(0) alignment(64) offset(%c1003520) flags("ReadOnly|Indirect") : !iree_tensor_ext.dispatch.tensor<readonly:tensor<2x784x49xf32>>
          %1 = hal.interface.binding.subspan layout(#pipeline_layout) binding(1) alignment(64) offset(%c1310848) flags(Indirect) : !iree_tensor_ext.dispatch.tensor<writeonly:tensor<2x25x49x32x1xf32>>
          ...
          %pack = linalg.pack %2 padding_value(%cst : f32) outer_dims_perm = [0, 1, 2] inner_dims_pos = [1, 2] inner_tiles = [32, 1] into %3 {lowering_config = #config} : tensor<2x784x49xf32> -> tensor<2x25x49x32x1xf32>
