...
#config1 = #iree_cpu.lowering_config<distribution = [1, 1, 5, 0, 0, 0, 0], vector_common_parallel = [1, 1, 1, 0, 7, 32, 0], vector_reduction = [0, 0, 0, 1, 0, 0, 1]>
...
module {
  ...
  hal.executable private @main_graph$async_dispatch_64 {
    hal.executable.variant public @embedded_elf_riscv_64 target(#executable_target_embedded_elf_riscv_64) {
      ...
      builtin.module {
        func.func @main_graph$async_dispatch_64_batch_mmt4d_2x5x25x49x7x32x1_f32() attributes {translation_info = #translation} {
          %cst = arith.constant 0.000000e+00 : f32
          %c631296 = arith.constant 631296 : index
          %c1310848 = arith.constant 1310848 : index
          %c401408 = arith.constant 401408 : index
          %0 = hal.interface.binding.subspan layout(#pipeline_layout) binding(0) alignment(64) offset(%c631296) flags("ReadOnly|Indirect") : !iree_tensor_ext.dispatch.tensor<readonly:tensor<2x5x49x7x1xf32>>
          %1 = hal.interface.binding.subspan layout(#pipeline_layout) binding(0) alignment(64) offset(%c1310848) flags("ReadOnly|Indirect") : !iree_tensor_ext.dispatch.tensor<readonly:tensor<2x25x49x32x1xf32>>
          %2 = hal.interface.binding.subspan layout(#pipeline_layout) binding(1) alignment(64) offset(%c401408) flags(Indirect) : !iree_tensor_ext.dispatch.tensor<writeonly:tensor<2x5x25x7x32xf32>>
          ...
          %6 = linalg.fill {lowering_config = #config} ins(%cst : f32) outs(%5 : tensor<2x5x25x7x32xf32>) -> tensor<2x5x25x7x32xf32>
          %7 = linalg.batch_mmt4d {lowering_config = #config1} ins(%3, %4 : tensor<2x5x49x7x1xf32>, tensor<2x25x49x32x1xf32>) outs(%6 : tensor<2x5x25x7x32xf32>) -> tensor<2x5x25x7x32xf32>
  ...
  util.global private mutable @main_graph$async_dispatch_64_embedded_elf_riscv_64_main_graph$async_dispatch_64_batch_mmt4d_2x5x25x49x7x32x1_f32_buffer : !hal.buffer
  util.initializer {
  ...
  util.func public @main_graph$async_dispatch_64_embedded_elf_riscv_64_main_graph$async_dispatch_64_batch_mmt4d_2x5x25x49x7x32x1_f32(%arg0: i32) attributes {iree.abi.stub, iree.reflection = {iree.benchmark = "dispatch"}} {
    ...
    %main_graph$async_dispatch_64_embedded_elf_riscv_64_main_graph$async_dispatch_64_batch_mmt4d_2x5x25x49x7x32x1_f32_buffer = util.global.load @main_graph$async_dispatch_64_embedded_elf_riscv_64_main_graph$async_dispatch_64_batch_mmt4d_2x5x25x49x7x32x1_f32_buffer : !hal.buffer
