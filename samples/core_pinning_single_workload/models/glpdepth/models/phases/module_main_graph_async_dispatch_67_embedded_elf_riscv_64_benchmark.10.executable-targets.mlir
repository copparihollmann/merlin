...
module {
  ...
  hal.executable private @main_graph$async_dispatch_67 {
    hal.executable.variant public @embedded_elf_riscv_64 target(#executable_target_embedded_elf_riscv_64) {
      hal.executable.export public @main_graph$async_dispatch_67_mmt4d_10x25x64x7x32x1_f32 ordinal(0) layout(#pipeline_layout) count(%arg0: !hal.device) -> (index, index, index) {
      ...
      builtin.module attributes {llvm.data_layout = "e-m:e-p:64:64-i64:64-i128:128-n32:64-S128", llvm.target_triple = "riscv64-unknown-unknown-eabi-elf"} {
        llvm.func @main_graph$async_dispatch_67_mmt4d_10x25x64x7x32x1_f32(%arg0: !llvm.ptr {llvm.align = 16 : i64, llvm.noalias, llvm.nonnull, llvm.noundef}, %arg1: !llvm.ptr {llvm.align = 16 : i64, llvm.noalias, llvm.nonnull, llvm.noundef}, %arg2: !llvm.ptr {llvm.align = 16 : i64, llvm.noalias, llvm.nonnull, llvm.noundef}) -> i32 {
          ...
          %7 = llvm.mlir.constant(448 : index) : i64
          ...
          %22 = llvm.mlir.constant(401408 : index) : i64
          ...
          llvm.intr.assume %6 ["align"(%46, %20 : !llvm.ptr, i64)] : i1
          ...
          %61 = llvm.mul %56, %18 overflow<nsw> : i64
          %62 = llvm.mul %60, %17 overflow<nsw> : i64
          llvm.br ^bb1(%21 : i64)
        ^bb1(%63: i64):  // 2 preds: ^bb0, ^bb8
          %64 = llvm.icmp "slt" %63, %18 : i64
          llvm.cond_br %64, ^bb2, ^bb9
        ^bb2:  // pred: ^bb1
          %65 = llvm.add %63, %61 : i64
          llvm.br ^bb3(%21 : i64)
        ^bb3(%66: i64):  // 2 preds: ^bb2, ^bb7
          %67 = llvm.icmp "slt" %66, %17 : i64
          llvm.cond_br %67, ^bb4, ^bb8
        ^bb4:  // pred: ^bb3
          %68 = llvm.add %66, %62 : i64
          llvm.br ^bb5(%21, %16 : i64, !llvm.array<7 x vector<32xf32>>)
        ^bb5(%69: i64, %70: !llvm.array<7 x vector<32xf32>>):  // 2 preds: ^bb4, ^bb6
          %71 = llvm.icmp "slt" %69, %20 : i64
          llvm.cond_br %71, ^bb6, ^bb7
        ^bb6:  // pred: ^bb5
          %72 = llvm.mul %68, %4 : i64
          %73 = llvm.mul %69, %5 : i64
          %74 = llvm.add %72, %73 : i64
          %75 = llvm.add %74, %21 : i64
          %76 = llvm.add %75, %21 : i64
          %77 = llvm.getelementptr %39[%76] : (!llvm.ptr, i64) -> !llvm.ptr, f32
          %78 = llvm.load %77 {alignment = 4 : i64} : !llvm.ptr -> vector<32xf32>
          %79 = llvm.mul %65, %7 overflow<nsw, nuw> : i64
          %80 = llvm.mul %69, %8 overflow<nsw, nuw> : i64
          %81 = llvm.add %79, %80 overflow<nsw, nuw> : i64
          %82 = llvm.add %81, %21 overflow<nsw, nuw> : i64
          %83 = llvm.add %82, %21 overflow<nsw, nuw> : i64
          %84 = llvm.getelementptr inbounds|nuw %32[%83] : (!llvm.ptr, i64) -> !llvm.ptr, f32
          ...
          %92 = llvm.getelementptr inbounds|nuw %32[%91] : (!llvm.ptr, i64) -> !llvm.ptr, f32
          ...
          %100 = llvm.getelementptr inbounds|nuw %32[%99] : (!llvm.ptr, i64) -> !llvm.ptr, f32
          ...
          %106 = llvm.add %81, %15 overflow<nsw, nuw> : i64
          ...
          %114 = llvm.add %81, %14 overflow<nsw, nuw> : i64
          ...
          %122 = llvm.add %81, %17 overflow<nsw, nuw> : i64
          %123 = llvm.add %122, %21 overflow<nsw, nuw> : i64
          %124 = llvm.getelementptr inbounds|nuw %32[%123] : (!llvm.ptr, i64) -> !llvm.ptr, f32
          ...
          %132 = llvm.getelementptr inbounds|nuw %32[%131] : (!llvm.ptr, i64) -> !llvm.ptr, f32
        ...
        ^bb7:  // pred: ^bb5
          ...
          %168 = llvm.getelementptr %46[%167] : (!llvm.ptr, i64) -> !llvm.ptr, f32
  ...
  util.global private @main_graph$async_dispatch_67_embedded_elf_riscv_64_main_graph$async_dispatch_67_mmt4d_10x25x64x7x32x1_f32_buffer : !hal.buffer
  util.initializer {
  ...
  util.func public @main_graph$async_dispatch_67_embedded_elf_riscv_64_main_graph$async_dispatch_67_mmt4d_10x25x64x7x32x1_f32(%arg0: i32) attributes {iree.abi.stub, iree.reflection = {iree.benchmark = "dispatch"}} {
    ...
    %main_graph$async_dispatch_67_embedded_elf_riscv_64_main_graph$async_dispatch_67_mmt4d_10x25x64x7x32x1_f32_buffer = util.global.load immutable @main_graph$async_dispatch_67_embedded_elf_riscv_64_main_graph$async_dispatch_67_mmt4d_10x25x64x7x32x1_f32_buffer : !hal.buffer
