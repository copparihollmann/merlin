module {
  ...
  hal.executable private @main_graph$async_dispatch_28 {
  ...
  util.global private mutable @main_graph$async_dispatch_28_system_elf_x86_64_main_graph$async_dispatch_28_matmul_like_1024x7x7x512_f32_buffer : !hal.buffer
  util.initializer {
    ...
    util.global.store %buffer, @main_graph$async_dispatch_28_system_elf_x86_64_main_graph$async_dispatch_28_matmul_like_1024x7x7x512_f32_buffer : !hal.buffer
    util.return
  }
  util.func public @main_graph$async_dispatch_28_system_elf_x86_64_main_graph$async_dispatch_28_matmul_like_1024x7x7x512_f32(%arg0: i32) attributes {iree.abi.stub, iree.reflection = {iree.benchmark = "dispatch"}} {
    %0 = arith.index_cast %arg0 : i32 to index
    %device, %queue_affinity = hal.device.resolve on(#hal.device.affinity<@__device_0>) : !hal.device, i64
    %cmd = hal.command_buffer.create device(%device : !hal.device) mode("OneShot|AllowInlineExecution") categories(Dispatch) affinity(%queue_affinity) : !hal.command_buffer
    %main_graph$async_dispatch_28_system_elf_x86_64_main_graph$async_dispatch_28_matmul_like_1024x7x7x512_f32_buffer = util.global.load @main_graph$async_dispatch_28_system_elf_x86_64_main_graph$async_dispatch_28_matmul_like_1024x7x7x512_f32_buffer : !hal.buffer
    ...
    %workgroup_x, %workgroup_y, %workgroup_z = hal.executable.calculate_workgroups device(%device : !hal.device) target(@main_graph$async_dispatch_28::@system_elf_x86_64::@main_graph$async_dispatch_28_matmul_like_1024x7x7x512_f32) : index, index, index
    %exe = hal.executable.lookup device(%device : !hal.device) executable(@main_graph$async_dispatch_28) : !hal.executable
    %ordinal = hal.executable.export.ordinal target(@main_graph$async_dispatch_28::@system_elf_x86_64::@main_graph$async_dispatch_28_matmul_like_1024x7x7x512_f32) : index
    %c1 = arith.constant 1 : index
    scf.for %arg1 = %c0 to %0 step %c1 {
      hal.command_buffer.dispatch<%cmd : !hal.command_buffer> target(%exe : !hal.executable)[%ordinal] workgroups([%workgroup_x, %workgroup_y, %workgroup_z]) bindings([
        (%main_graph$async_dispatch_28_system_elf_x86_64_main_graph$async_dispatch_28_matmul_like_1024x7x7x512_f32_buffer : !hal.buffer)[%c0, %c10538048], 
        (%main_graph$async_dispatch_28_system_elf_x86_64_main_graph$async_dispatch_28_matmul_like_1024x7x7x512_f32_buffer : !hal.buffer)[%c10538240, %c15732224], 
        (%main_graph$async_dispatch_28_system_elf_x86_64_main_graph$async_dispatch_28_matmul_like_1024x7x7x512_f32_buffer : !hal.buffer)[%c26270464, %c10538048]
      ]) flags("None")
