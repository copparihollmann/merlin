...
define void @softmax_matmul(ptr %0, ptr %1, i64 %2, i64 %3, i64 %4, i64 %5, i64 %6, ptr %7, ptr %8, i64 %9, i64 %10, i64 %11, i64 %12, i64 %13, ptr %14, ptr %15, i64 %16, i64 %17, i64 %18, i64 %19, i64 %20, ptr %21, ptr %22, i64 %23, i64 %24, i64 %25, i64 %26, i64 %27) {
  %29 = ptrtoint ptr %1 to i64
  %30 = ptrtoint ptr %8 to i64
  %31 = ptrtoint ptr %15 to i64
  %32 = ptrtoint ptr %22 to i64
  call void @llvm.riscv.config.ex(i64 4575657221408489476, i64 281474976710656)
  call void @llvm.riscv.config.st(i64 2, i64 4575657221408424002)
  call void @llvm.riscv.config.ld(i64 4575657221409472769, i64 30)
  call void @llvm.riscv.config.ld(i64 4575657221409472777, i64 66)
  call void @llvm.riscv.config.ld(i64 4575657221409472785, i64 264)
  call void @llvm.riscv.config.norm(i64 55834640387, i64 1644972474395)
  call void @llvm.riscv.config.norm(i64 21650930466819, i64 1644972474395)
  call void @llvm.riscv.loop.ws.config.bounds(i64 8590852097, i64 8590262274)
  call void @llvm.riscv.loop.ws.config.addrs.ab(i64 %29, i64 %30)
  call void @llvm.riscv.loop.ws.config.addrs.dc(i64 %32, i64 %31)
  call void @llvm.riscv.loop.ws.config.strides.ab(i64 30, i64 66)
  call void @llvm.riscv.loop.ws.config.strides.dc(i64 66, i64 66)
  call void @llvm.riscv.loop.ws(i64 1025, i64 0)
  call void @llvm.riscv.flush(i64 0, i64 0)
  ret void
}

define void @_mlir_ciface_softmax_matmul(ptr %0, ptr %1, ptr %2, ptr %3) {
  ...
  call void @softmax_matmul(ptr %6, ptr %7, i64 %8, i64 %9, i64 %10, i64 %11, i64 %12, ptr %14, ptr %15, i64 %16, i64 %17, i64 %18, i64 %19, i64 %20, ptr %22, ptr %23, i64 %24, i64 %25, i64 %26, i64 %27, i64 %28, ptr %30, ptr %31, i64 %32, i64 %33, i64 %34, i64 %35, i64 %36)
  ret void
}
